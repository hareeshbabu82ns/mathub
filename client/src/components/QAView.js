      ...
      <Stack direction="row" spacing={2}>
        ...
        <Stack sx={{ alignItems: 'flex-end' }}>
          <Stack direction="row" spacing={2}>
            <div> </div>
            <div>
              <Typography fontSize={32}>{question.operand1}</Typography>
            </div>
          </Stack>
          <Stack direction="row" spacing={2}>
            <div>
              <Typography fontSize={32}>
                {ARITHMETIC_OPERATION_SIGN[question.operator1].symbol}
              </Typography>
            </div>
            <div>
              <Typography fontSize={32}>{question.operand2}</Typography>
            </div>
          </Stack>
        </Stack>
      </Stack>
